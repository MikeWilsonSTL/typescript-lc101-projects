...
// console.log(`It will take ${spacecraftName} ${getDaysToLocation(384400)} days to get to the Moon!`);
// console.log(`It will take ${spacecraftName} ${getDaysToLocation(225000000)} days to get to Mars!`);
